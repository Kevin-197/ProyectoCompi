...
"<<" | ">>" | "~" | "&" | "|" | "^" {return new Symbol(sym.OperadorDeBit, yychar, yyline, yytext());}
...
", yychar, yyline, yytext());" {return new Symbol(sym.PuntoComa, yychar, yyline, yytext());}
...
{char}|{string} {return new Symbol(sym.Literal, yychar, yyline, yytext());}
